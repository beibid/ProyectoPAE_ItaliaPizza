...
public class VentanaPrincipalControlador {
    ...
    public void abrirGestionUsuarios() {
        abrirVentanaModal("/italiapizza/fxml/Usuarios.fxml", "Gestión de Usuarios", 780, 500);
    }

    @FXML
    public void abrirGestionProductos() {
        abrirVentanaModal("/italiapizza/fxml/Productos.fxml", "Gestión de Productos", 760, 480);
    }

    @FXML
    public void abrirValidacionInventario() {
        abrirVentanaModal("/italiapizza/fxml/ValidacionInventario.fxml",
    ...
    public void ejecutarCierreSesion() {
        ...
        try {
            ...
            LoginControlador.mostrarEn(escenario);
